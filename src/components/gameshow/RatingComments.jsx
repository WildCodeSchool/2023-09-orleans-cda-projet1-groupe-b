...
export default function RatingComments({
  ...
  return (
    <div className="h-fit w-[800px] rounded-lg border border-solid border-primary bg-gradient-to-l from-primary/30 to-primary/20 p-4 py-2 text-start">
      <form className="m-4" onSubmit={handleSubmit}>
        <div className="mb-5 flex flex-col">
          <label className="pb-2 text-2xl text-light" htmlFor="character">
            Pseudo
          </label>
          <input
            id="character"
        ...
        <div className="my-3 mb-5 flex flex-col">
          ...
          <textarea
            ...
            className="rounded bg-tertiary pb-20 pl-3 pt-2 text-light"
        ...
        <div className="flex items-center gap-4 py-2">
          <div className="text-2xl text-light">Rate this game</div>
        ...
        <div className="me-4 mt-10 flex justify-end gap-4">
          <button
            className="h-12 w-36 -skew-x-35 rounded-lg border border-primary text-2xl font-bold text-primary"
            type="reset"
          >
            <div className="skew-x-35">Cancel</div>
          </button>
          <button
            className="h-12 w-36 -skew-x-35 rounded-lg border border-primary bg-primary text-2xl font-bold text-tertiary"
