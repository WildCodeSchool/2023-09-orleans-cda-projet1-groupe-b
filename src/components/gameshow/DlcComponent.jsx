          ...
          <div className="mt-5 h-[26rem] overflow-auto pb-2 ">
            <div className="flex flex-col flex-nowrap gap-3">
              {dlc.results.map((d) => (
                <div
                  key={d.id}
                  className="rightbar border-black container relative overflow-hidden rounded-lg border opacity-50 transition duration-150 hover:-translate-y-0.5 hover:opacity-100"
                >
                  <img
